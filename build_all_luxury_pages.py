...
<body>
  ...
  <main class="container">
    ...
    <div class="page-header">
      <span class="page-pill">TRACK A · 5-DAY FAST-TRACK SPRINT</span>
      <h1 class="page-title">معسكر الـ 5 أيام المكثف: <span>الزبدة التطبيقية لفرق OTB</span></h1>
      <p class="page-subtitle">دورة تدريبية سريعة ومضغوطة تركز على النماذج التكتيكية الفورية لكل دور وظيفي في الوكالة مع تكليفات عمل حقيقية وتتبع إنجاز.</p>
    </div>
    ...
    <div class="grid-2">
      ...
      <div>
        <div class="card" style="padding: 1.35rem;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
            <h3 style="color: var(--gold-100); font-size: 1.1rem; font-weight: 800;">📅 أيام المعسكر</h3>
            <span id="sprintProgressBadge" class="page-pill" style="margin: 0; font-size: 0.72rem; padding: 0.15rem 0.55rem; color: var(--emerald); border-color: var(--emerald);">0% مكتمل</span>
          </div>

          <div class="sidebar-list">
            <div class="sidebar-item active" id="sideDay1" onclick="loadDay(1)">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span class="item-badge">Day 01</span>
                <span id="checkDay1" style="font-size: 0.8rem; color: var(--text-dim);">○ لم يكتمل</span>
              </div>
              <div class="item-title">تحليل السوق والتموضع (STP)</div>
              <div class="item-meta">👥 الاستراتيجيين ومدراء الحسابات</div>
            </div>

            <div class="sidebar-item" id="sideDay2" onclick="loadDay(2)">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span class="item-badge">Day 02</span>
                <span id="checkDay2" style="font-size: 0.8rem; color: var(--text-dim);">○ لم يكتمل</span>
              </div>
              <div class="item-title">محرك الكرييتف وسيكولوجية الريلز</div>
              <div class="item-meta">✍️ كتاب المحتوى والمصممون</div>
            </div>

            <div class="sidebar-item" id="sideDay3" onclick="loadDay(3)">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span class="item-badge">Day 03</span>
                <span id="checkDay3" style="font-size: 0.8rem; color: var(--text-dim);">○ لم يكتمل</span>
              </div>
              <div class="item-title">ميديا بايينج الأداء وسكيلينج ROAS</div>
              <div class="item-meta">📊 ميديا بايرز وهندسة النمو</div>
            </div>

            <div class="sidebar-item" id="sideDay4" onclick="loadDay(4)">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span class="item-badge">Day 04</span>
                <span id="checkDay4" style="font-size: 0.8rem; color: var(--text-dim);">○ لم يكتمل</span>
              </div>
              <div class="item-title">الذكاء الاصطناعي وأتمتة الواتساب</div>
              <div class="item-meta">🤖 جميع أعضاء الفريق</div>
            </div>

            <div class="sidebar-item" id="sideDay5" onclick="loadDay(5)">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span class="item-badge">Day 05</span>
                <span id="checkDay5" style="font-size: 0.8rem; color: var(--text-dim);">○ لم يكتمل</span>
              </div>
      ...
      <!-- LESSON CONTAINER -->
      <div id="lessonContainer" class="card" style="padding: 2.25rem;"></div>
    </div>
