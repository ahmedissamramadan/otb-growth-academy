...
# REAL CLIENTS WITH DIRECT SOCIAL LINKS AND AUTHENTIC ASSETS
REAL_CLIENTS_DATA = [
  {
    ...
    "image": "assets/images/OTP_Strategic_Blueprint_-_Slide_2.png"
  },
  {
    "name": "MIX Coffee (ميكس كوفي)",
    "sector": "Specialty Coffee / قطاع الضيافة والكافيهات",
    "metric": "تفاعل +180% | مضاعفة مبيعات الفروع",
    "desc": "إعادة التموضع من كافيه تقليدي إلى وجهة أولى لرواد الأعمال بهوية بصرية داكنة فاخرة، وفيديوهات ASMR لصناعة القهوة حققت انتشاراً واسعاً على السوشيال ميديا.",
  ...
  },
  {
    ...
    "socialLink": "https://www.facebook.com/otbagency5",
    "image": "assets/images/arabic_portfolio.jpg"
  },
  {
    ...
    "socialLink": "https://www.facebook.com/otbagency5",
    "image": "assets/images/541616658_767052649291580_3125367341401312311_n.jpg"
  },
  {
    ...
    "socialLink": "https://www.facebook.com/otbagency5",
    "image": "assets/images/542857690_767054315958080_2395724451370984613_n.jpg"
  }
]
...
# REAL VISUAL SHOWCASE ASSETS
REAL_GALLERY_ASSETS = [
  {
    "title": "MIX Coffee Visual Campaign",
    "cat": "Specialty Coffee & Hospitality",
    "src": "assets/images/portfolio1.jpg",
    "link": "https://www.facebook.com/people/MIX-Coffee-Mart/100063935293290/",
    "desc": "الحملة البصرية الرسمية لبراند MIX Coffee في ميت غمر ومنافذ الفروع."
  },
  {
    "title": "Rancho’s Gourmet Burger Campaigns",
    "cat": "Gourmet Burgers & Food Production",
    "src": "assets/images/portfolio2.jpg",
    "link": "https://www.facebook.com/ranchos.eg",
    "desc": "حملات تصوير وإعلانات رانشوز برجر (الخط الساخن: 19484)."
  },
  {
    "title": "Dr. Zaghloul Jewelry Craft",
    "cat": "Luxury Gold & Haute Joaillerie",
    "src": "assets/images/arabic_portfolio.jpg",
    "link": "https://www.facebook.com/otbagency5",
    "desc": "تصوير وإنتاج إعلانات مجوهرات دكتور زغلول الحصرية."
  },
  {
    "title": "OTB Official 3D Brand Masterpiece",
    "cat": "Agency Brand Identity",
    "src": "assets/images/otb_official_showcase.jpg",
    "link": "https://www.facebook.com/otbagency5",
    "desc": "الهوية البصرية ثلاثية الأبعاد الرسمية لوكالة OTB (The City Kings)."
  },
  {
    "title": "OTB Agency Scale Strategic Blueprint",
    "cat": "Strategy & Enterprise Scale",
    "src": "assets/images/OTP_Strategic_Blueprint_-_Slide_2.png",
    "link": "https://www.facebook.com/otbagency5",
    "desc": "مخطط التحول المؤسسي وخارطة طريق نمو وكالة OTB."
  },
  {
    "title": "OTB Operations & Creative Direction",
    "cat": "Social Media Production",
    "src": "assets/images/542857690_767054315958080_2395724451370984613_n.jpg",
    "link": "https://www.facebook.com/otbagency5",
    "desc": "نماذج الإنتاج الإبداعي المباشر من مجتمع فيسبوك الوكالة (+33K)."
  }
]
...
<body>
  ...
  <header class="navbar">
    ...
    <nav class="nav-pills">
      ...
      <button class="nav-pill-btn" id="tabBtn-gallery" onclick="switchMainTab('gallery')">🎨 المعرض البصري الحقيقي</button>
  ...
  <main class="app-container">
    ...
    <!-- ========================================== -->
    <!-- SECTION 2: REAL VISUAL SHOWCASE (LIGHTBOX) -->
    <!-- ========================================== -->
    <section id="section-gallery" class="hub-section" style="display: none;">
      <div class="hero-wrapper" style="margin-bottom: 2.5rem;">
        <div class="hero-pill">📸 100% REAL SOCIAL & CLIENT ASSETS</div>
        <h2 class="hero-title">معرض الأعمال البصرية <span>والإنتاج الحقيقي</span></h2>
        <p class="hero-subtitle">أصول بصرية حقيقية ملتقطة ومصممة لعملاء OTB على صفحات السوشيال ميديا ومخططات الاستراتيجية الرسمية.</p>
      </div>
  ...
  <div id="lightboxModal" style="display: none; position: fixed; inset: 0; background: rgba(0, 0, 0, 0.94); z-index: 999999; backdrop-filter: blur(24px); justify-content: center; align-items: center; padding: 2rem;" onclick="closeLightbox()">
    <div style="max-width: 960px; width: 100%; text-align: center; position: relative;" onclick="event.stopPropagation()">
      ...
      <div style="margin-top: 1.5rem; display: flex; justify-content: center; gap: 1rem;">
        <a id="lightboxSocialBtn" href="#" target="_blank" class="btn btn-primary" style="font-size: 0.88rem; padding: 0.5rem 1.5rem;">🌐 زيارة صفحة البراند الرسمية</a>
  ...
  <script>
        ...
        html += `
          <div class="glass-card" style="padding: 0.9rem; overflow: hidden; cursor: pointer;" onclick="openLightbox('${{g.src}}', '${{g.title}}', '${{g.desc}}', '${{g.link}}')">
            ...
            <div style="padding: 0.9rem 0.5rem 0.35rem 0.5rem;">
              ...
              <h4 style="font-family: var(--font-felfel); font-size: 1.2rem; color: #fff; margin: 0.2rem 0;">${{g.title}}</h4>
    ...
    function renderClientsGrid() {{
      ...
      clientsData.forEach(c => {{
        html += `
          <div class="glass-card">
            <div style="margin-bottom: 1rem; border-radius: var(--radius-sm); overflow: hidden; height: 160px;">
            ...
            <a href="${{c.socialLink}}" target="_blank" class="btn btn-secondary" style="width: 100%; font-size: 0.85rem; padding: 0.5rem;">🌐 زيارة صفحة فيسبوك الرسمية</a>
          </div>
        `;
      }});
      container.innerHTML = html;
...
print("Generated 100% Real Social Sourced index.html")
