...
from build_factual_otb_portal import REAL_ROLES_DATA, REAL_CLIENTS_DATA, COURSES_DATA
...
<head>
  ...
  <title>👑 OTB Team AI Hub — التحفة المعمارية لتمكين ملوك المدينة</title>
...
<body>
  ...
  <header class="navbar">
    ...
    <nav class="nav-pills">
      ...
      <button class="nav-pill-btn" id="tabBtn-gallery" onclick="switchMainTab('gallery')">🎨 المعرض البصري</button>
  ...
  <main class="app-container">
    ...
    <section id="section-roles" class="hub-section">
      ...
      <div class="hero-wrapper">
        ...
        <p class="hero-subtitle">
          بيانات حقيقية 100% مستخلصة من الدليل الرسمي للمسميات وخارطة طريق OTB Agency. اكتشف دورك المعتمد، وتعرف كيف تختزل أدوات الذكاء الاصطناعي 40% من وقت المهام الروتينية لتبدع كأحد ملوك المدينة.
        </p>
      </div>
    ...
    <!-- ========================================== -->
    <!-- SECTION 3: VISUAL SHOWCASE (LIGHTBOX) -->
    <!-- ========================================== -->
    <section id="section-gallery" class="hub-section" style="display: none;">
      <div class="hero-wrapper" style="margin-bottom: 2.5rem;">
        <div class="hero-pill">✨ OTB VISUAL MASTERPIECES</div>
        <h2 class="hero-title">معرض الهوية والأعمال <span>البصرية الراقية</span></h2>
        <p class="hero-subtitle">استعراض حقيقي للأعمال البصرية ثلاثية الأبعاد وحملات كبرى البراندات التي صنعتها أيادي مصممي OTB.</p>
      </div>

      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
        <div class="glass-card" style="padding: 0.85rem; overflow: hidden; cursor: pointer;" onclick="openLightbox('assets/images/otb_official_showcase.jpg', 'OTB Official 3D Masterpiece')">
          <img src="assets/images/otb_official_showcase.jpg" alt="OTB Showcase" style="width: 100%; height: 220px; object-fit: cover; border-radius: var(--radius-sm); transition: transform 0.4s ease;">
          <div style="padding: 0.85rem 0.5rem 0.25rem 0.5rem;">
            <span style="font-size: 0.75rem; color: var(--gold); font-weight: 800;">Brand Identity</span>
            <h4 style="font-family: var(--font-felfel); font-size: 1.15rem; color: #fff;">OTB Official 3D Brand Masterpiece</h4>
          </div>
        </div>

        <div class="glass-card" style="padding: 0.85rem; overflow: hidden; cursor: pointer;" onclick="openLightbox('assets/images/portfolio1.jpg', 'MIX Coffee Visual Identity')">
          <img src="assets/images/portfolio1.jpg" alt="MIX Coffee" style="width: 100%; height: 220px; object-fit: cover; border-radius: var(--radius-sm); transition: transform 0.4s ease;">
          <div style="padding: 0.85rem 0.5rem 0.25rem 0.5rem;">
            <span style="font-size: 0.75rem; color: var(--gold); font-weight: 800;">Specialty Coffee</span>
            <h4 style="font-family: var(--font-felfel); font-size: 1.15rem; color: #fff;">MIX Coffee Noir Visual Identity</h4>
          </div>
        </div>

        <div class="glass-card" style="padding: 0.85rem; overflow: hidden; cursor: pointer;" onclick="openLightbox('assets/images/portfolio2.jpg', 'Rancho’s Epic Campaigns')">
          <img src="assets/images/portfolio2.jpg" alt="Rancho’s" style="width: 100%; height: 220px; object-fit: cover; border-radius: var(--radius-sm); transition: transform 0.4s ease;">
          <div style="padding: 0.85rem 0.5rem 0.25rem 0.5rem;">
            <span style="font-size: 0.75rem; color: var(--gold); font-weight: 800;">Gourmet Burgers</span>
            <h4 style="font-family: var(--font-felfel); font-size: 1.15rem; color: #fff;">Rancho's Epic Gourmet Campaigns</h4>
          </div>
        </div>

        <div class="glass-card" style="padding: 0.85rem; overflow: hidden; cursor: pointer;" onclick="openLightbox('assets/images/arabic_portfolio.jpg', 'Dr. Zaghloul Luxury Jewelry')">
          <img src="assets/images/arabic_portfolio.jpg" alt="Dr. Zaghloul" style="width: 100%; height: 220px; object-fit: cover; border-radius: var(--radius-sm); transition: transform 0.4s ease;">
          <div style="padding: 0.85rem 0.5rem 0.25rem 0.5rem;">
            <span style="font-size: 0.75rem; color: var(--gold); font-weight: 800;">Luxury Gold</span>
            <h4 style="font-family: var(--font-felfel); font-size: 1.15rem; color: #fff;">Dr. Zaghloul Luxury Campaigns</h4>
          </div>
        </div>
      </div>
    </section>
  ...
  <!-- LIGHTBOX MODAL -->
  <div id="lightboxModal" style="display: none; position: fixed; inset: 0; background: rgba(0, 0, 0, 0.92); z-index: 999999; backdrop-filter: blur(20px); justify-content: center; align-items: center; padding: 2rem;" onclick="closeLightbox()">
    <div style="max-width: 900px; width: 100%; text-align: center; position: relative;" onclick="event.stopPropagation()">
      <img id="lightboxImg" src="" style="max-width: 100%; max-height: 75vh; border-radius: var(--radius-md); border: 2px solid var(--gold); box-shadow: 0 0 50px rgba(212, 168, 83, 0.4);">
      <h3 id="lightboxCaption" style="font-family: var(--font-felfel); font-size: 1.3rem; color: var(--gold-champagne); margin-top: 1rem;"></h3>
      <button class="btn btn-secondary" style="margin-top: 1rem;" onclick="closeLightbox()">✕ إغلاق المعاينة</button>
    </div>
  </div>
        ...
        html += `
          <div class="glass-card">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
              <span style="font-size: 0.8rem; color: var(--gold); font-weight: 800;">${{c.sector}}</span>
            ...
            <h3 style="font-family: var(--font-felfel); font-size: 1.3rem; color: var(--text-pure); margin-bottom: 0.4rem;">${{c.name}}</h3>
            <p style="font-size: 0.92rem; color: var(--text-muted); line-height: 1.75;">${{c.desc}}</p>
          </div>
        `;
      }});
...
print("Generated Transcendental Bento index.html")
