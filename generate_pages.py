...
# ==============================================================================
# 2. SPRINT.HTML (5-DAY SPRINT MASTERCLASS)
# ==============================================================================
sprint_html = f"""<!DOCTYPE html>
<html lang="ar" dir="rtl">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  ...
  <main class="container">
    ...
    <div class="grid-2">
      ...
      <div id="lessonContainer" class="lesson-content">
...
# ==============================================================================
# 3. MASTERCLASS.HTML (4-WEEK FULL ACADEMY)
# ==============================================================================
masterclass_html = f"""<!DOCTYPE html>
<html lang="ar" dir="rtl">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  ...
  <main class="container">
    ...
    <div class="grid-2">
      ...
      <!-- MAIN WEEK DETAIL -->
      <div id="weekContainer" class="lesson-content">
        <!-- Injected via JS -->
      </div>
    </div>
...
# ==============================================================================
# 4. PROMPTS.HTML (AI PROMPTS STUDIO)
# ==============================================================================
prompts_html = f"""<!DOCTYPE html>
<html lang="ar" dir="rtl">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
# ==============================================================================
# 5. CASE-STUDIES.HTML (CASE STUDIES & KNOWLEDGE BASE)
# ==============================================================================
case_studies_html = f"""<!DOCTYPE html>
<html lang="ar" dir="rtl">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  ...
  <main class="container">
    ...
    <!-- MARKETING FRAMEWORKS CHEATSHEET -->
    <h2 style="font-size: 1.5rem; font-weight: 800; color: var(--gold-light); margin-bottom: 1.5rem; border-right: 4px solid var(--gold-primary); padding-right: 0.75rem;">
...
# ==============================================================================
# 6. QUIZ.HTML (EXAM SIMULATOR & INSTANT CERTIFICATE)
# ==============================================================================
...
# ==============================================================================
# 7. SOPS.HTML (OPERATIONS & BRIEF GENERATOR)
# ==============================================================================
sops_html = f"""<!DOCTYPE html>
<html lang="ar" dir="rtl">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
# ==============================================================================
# 8. DOWNLOADS.HTML (DOWNLOADS & RESOURCE CENTER)
# ==============================================================================
...
pages_dict = {
    ...
    "sprint.html": sprint_html,
    "masterclass.html": masterclass_html,
    "prompts.html": prompts_html,
    "case-studies.html": case_studies_html,
    "quiz.html": quiz_html,
    "sops.html": sops_html,
    "downloads.html": downloads_html
}

print("Writing all 8 dedicated academy pages...")
