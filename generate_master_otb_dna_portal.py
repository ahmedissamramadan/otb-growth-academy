...
# ==============================================================================
# 1. LUXURY OTB BRAND SYSTEM (style.css)
# ==============================================================================
lms_css = """
:root {
  --bg-app: #06070A;
  ...
  --border-gold-bright: rgba(212, 168, 83, 0.6);
  ...
  --gold-glow: 0 0 35px rgba(212, 168, 83, 0.2);
...
print("Generated Brand-Accurate style.css")

# ==============================================================================
# 2. MASTER LMS HTML WITH 16 ROLES, DISCOVERY SYSTEM & FULL DNA (index.html)
# ==============================================================================
...
<head>
  ...
  <title>👑 OTB Growth Academy — البوابة المعرفية الموحدة لملوك المدينة</title>
...
<body>
  ...
  <header class="app-header">
    <div class="brand-section">
      <img src="assets/otb_logo.jpg" alt="OTB Logo" class="brand-logo-img">
    ...
    <main class="main-stage">
      ...
      <div id="view-overview" class="lms-view">
        <div style="position: relative; border-radius: var(--radius-lg); overflow: hidden; margin-bottom: 2.5rem; border: 1px solid var(--border-gold);">
          <img src="assets/otb_banner.jpg" alt="OTB Banner" style="width: 100%; height: 200px; object-fit: cover; filter: brightness(0.6);">
          <div style="position: absolute; inset: 0; background: linear-gradient(to top, #06070A 0%, rgba(6, 7, 10, 0.4) 100%); display: flex; flex-direction: column; justify-content: flex-end; padding: 1.5rem 2rem;">
            <span style="font-size: 0.75rem; color: var(--gold); font-weight: 700; letter-spacing: 2px;">OFFICIAL AGENCY VISION · 2026</span>
            <h2 style="font-size: 2rem; color: var(--text-pure); font-weight: 900; margin-top: 0.2rem;">WE ARE OTB, THE CITY KINGS 👑</h2>
            <p style="color: var(--gold-light); font-size: 0.95rem; font-weight: 600;">استراتيجيات جريئة.. نتائج حقيقية | Bold Strategies · Real Results</p>
          </div>
        </div>

        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-bottom: 2.5rem;">
          <div class="card" style="text-align: center; padding: 1.25rem;">
            <div style="font-family: var(--font-royal); font-size: 1.8rem; font-weight: 800; color: var(--gold);">7+</div>
            <div style="font-size: 0.8rem; color: var(--text-muted);">سنوات من الخبرة والريادة</div>
          </div>
          <div class="card" style="text-align: center; padding: 1.25rem;">
            <div style="font-family: var(--font-royal); font-size: 1.8rem; font-weight: 800; color: var(--cyan);">33K+</div>
            <div style="font-size: 0.8rem; color: var(--text-muted);">مجتمع فيسبوك الرسمي</div>
          </div>
          <div class="card" style="text-align: center; padding: 1.25rem;">
            <div style="font-family: var(--font-royal); font-size: 1.8rem; font-weight: 800; color: var(--emerald);">11+</div>
            <div style="font-size: 0.8rem; color: var(--text-muted);">براندات تجارية كبرى مخدومة</div>
          </div>
          <div class="card" style="text-align: center; padding: 1.25rem;">
            <div style="font-family: var(--font-royal); font-size: 1.8rem; font-weight: 800; color: var(--purple);">16</div>
            <div style="font-size: 0.8rem; color: var(--text-muted);">دوراً وظيفياً متخصصاً</div>
          </div>
        </div>

        <h3 style="font-size: 1.2rem; color: var(--text-pure); margin-bottom: 1.25rem; font-weight: 700;">المراحل المعمارية الـ 4 للمنهج:</h3>
      ...
      <div id="view-roles" class="lms-view" style="display: none;">
        <div style="margin-bottom: 1.75rem;">
          <h2 style="font-size: 1.6rem; color: var(--text-pure); margin-bottom: 0.35rem; font-weight: 800;">🏛️ الدليل الرسمي للمسميات والـ 16 دوراً وظيفياً</h2>
      ...
      <div id="view-discovery" class="lms-view" style="display: none;">
        <div style="margin-bottom: 1.75rem;">
          <h2 style="font-size: 1.6rem; color: var(--text-pure); margin-bottom: 0.35rem; font-weight: 800;">🎯 نظام بريف الاكتشاف الاستراتيجي (9 مراحل)</h2>
      ...
      list.forEach(r => {{
        html += `
          <div class="card" style="margin-bottom: 1rem;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.4rem;">
              <h3 style="font-size: 1.15rem; color: var(--gold);">${{r.title}}</h3>
...
print("Generated master LMS index.html with 16 roles and full OTB DNA")
